...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/irmu/moria/master/_tools/builds/nimble.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]NIMBLE[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
